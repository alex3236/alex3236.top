...
export default function Footer() {
    return (
        <div
            id='icp'
            className="z-20 fixed mt-6 bottom-0 w-full lg:w-fit lg:bottom-4 lg:left-4 bg-opacity-55 justify-center items-center flex align-middle text-white bg-gray-700"
        >
